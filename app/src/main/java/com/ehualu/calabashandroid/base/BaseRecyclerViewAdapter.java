 ...
 * <p>
 * 封装了数据集合以及ItemView的点击事件回调,同时暴露 {@link #onBindData(BaseRecyclerViewHolder, Object, int)}
 * 用于数据与view绑定
 *
...
public abstract class BaseRecyclerViewAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> implements View.OnClickListener {
     ...
     */
    protected abstract void onBindData(BaseRecyclerViewHolder holder, T bean, int position);
