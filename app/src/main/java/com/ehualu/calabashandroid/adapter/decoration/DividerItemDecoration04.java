...
public class DividerItemDecoration04 extends Y_DividerItemDecoration {

    public DividerItemDecoration04(Context context) {
        super(context);
    }
        ...
        switch (itemPosition % 3) {
            case 0:
                divider = new Y_DividerBuilder()
                        ...
                        .setBottomSideLine(true, 0x00000000, 30, 0, 0)
                        .create();
                break;
            case 1:
                divider = new Y_DividerBuilder()
