 ...
 * 已上传的本地视频列表
 */
public class UploadedFragment extends BaseFragment implements VideoOnItemClickInterface {
                    ...
                    public void onNext(List<String> strings) {
                        videoHelper.initVideo(activity, new DataCallBack() {
                            ...
                            public void onReadFinished(List<VideoList> videos) {
                                ...
                                lists.addAll(videos);
                                adapter = new SelectVideoAdapter(activity, lists, UPLOADED);
                                recyVideoList.setLayoutManager(new LinearLayoutManager(activity));
                                recyVideoList.setAdapter(adapter);
                                adapter.setListener(UploadedFragment.this);
                            }
                        });
                    }
