...
public class UnUploadPhotoFragment extends BaseFragment implements PhotoOnItemClickInterface {
    ...
    public UnUploadPhotoFragment(int buck_id) {
    ...
    protected void setUpView() {
        adapter = new PhotoAdapter(activity, paths, UN_UPLOAD,dirID);
        ...
        adapter.setListener(UnUploadPhotoFragment.this);
