 ...
 * author: houxiansheng
 * <p>
 * time：2019-12-12 21:26:32
 * <p>
 * describe：删除弹窗
 */
public class BottomDeletePopupWindow extends PopupWindow implements View.OnClickListener {
    private PopupWindow popupWindow;
    private Activity mContext;
    private ConfirmCancelInterface bottomDeleteInterface;
    private List<RemoteFile> list;

    public BottomDeletePopupWindow(Activity mContext, ConfirmCancelInterface bottomDeleteInterface, List<RemoteFile> list) {
    ...
    public void showMoreOperationPopup(View view) {
        ...
        View contentView = LayoutInflater.from(mContext).inflate(R.layout.popup_delete_file, null);
