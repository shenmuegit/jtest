...
public class AllPhotoFragment extends BaseFragment implements PhotoOnItemClickInterface {
    ...
    public AllPhotoFragment(int buck_id) {
    ...
    protected void setUpView() {
        adapter = new PhotoAdapter(activity, paths, ALL_UPLOAD, dirID);
